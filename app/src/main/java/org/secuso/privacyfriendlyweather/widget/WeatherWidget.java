...
public class WeatherWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.widget_city_weather_temperature, number);
        views.setTextViewText(R.id.widget_city_weather_humidity, number);
        views.setImageViewResource(R.id.widget_city_weather_image_view, R.mipmap.weather_icon_sunny_with_clouds);
