...
public class WeatherWidgetOneDayForecastConfigureActivity extends Activity {
    ...
    private void handleOk() {
        final Context context = WeatherWidgetOneDayForecastConfigureActivity.this;
        ...
        addLocationWidgetTask.execute(selectedCity, mAppWidgetId, 2);
    ...
    public WeatherWidgetOneDayForecastConfigureActivity() {
        super();
    }
